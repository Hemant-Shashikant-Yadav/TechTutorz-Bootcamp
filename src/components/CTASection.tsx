      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-lg md:text-xl text-white/90 mb-8">
            Join our 7-week bootcamp and transform your career prospects.
          ...
          <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-8 mb-10">
            <div className="flex items-center">
              ...
              <span>Next Batch: June 15, 2025</span>
            </div>
            <div className="flex items-center">
          ...
          <button className="bg-white text-orange-600 hover:bg-orange-50 font-semibold py-3 px-8 rounded-md text-lg transition-all duration-300 transform hover:scale-105">
            Register Now
          </button>
        </div>
      </div>
